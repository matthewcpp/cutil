...
\returns integer value indicating the result of the comparison.  < 0 indicates that the first item is less than the second.  0 indicates that the items are equal.  1 indicates that the first item is greater than the second.
*/
